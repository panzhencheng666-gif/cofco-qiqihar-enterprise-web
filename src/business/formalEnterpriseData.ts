...
import { fixtureMasterDataAuthorization } from "./core/platformMasterData";

export const businessClassificationFixtures =
...
export const fixtureShellIdentity: FormalShellIdentity = {
...
export const fixtureOperationalIdentity: OperationalScopeIdentity = {
  workUnit: {
...
export const formalApplicationDefinitions: readonly FormalApplicationDefinition[] =
  [
    ...
    },
    {
      ...
      label: "总揽监测",
      shortLabel: "总揽",
      note: "进入总揽监测地图；地图边界与指标按业务平台授权范围和已核定数据同步",
      navigation: [
        {
    ...
    },
    {
      ...
      navigation: [
        ...
        {
          route: createFormalRoute("production", "soybean-collection"),
          label: "大豆产情填报",
        },
        {
    ...
    },
    {
      ...
      navigation: [
        ...
        {
          route: createFormalRoute("market", "soybean-collection"),
          label: "大豆市场采集",
        },
        {
          route: createFormalRoute("market", "paddy-collection"),
          label: "稻谷市场采集",
        },
        {
