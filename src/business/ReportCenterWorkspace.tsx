...
> = {
  ...
  "reporting.production": "产情业务报告",
  "reporting.market": "市场业务报告",
  "reporting.supply": "供需业务报告",
...
function BusinessReports({
  ...
  const authorization =
    formalScope?.scope.authorization ?? fixtureMasterDataAuthorization;
...
export function ReportCenterWorkspace({
  ...
  onComposeReport,
  onQuickExport,
  workflow = getFallbackFixtureBusinessReportWorkflow(),
  actorPost = "区域数据管理员",
