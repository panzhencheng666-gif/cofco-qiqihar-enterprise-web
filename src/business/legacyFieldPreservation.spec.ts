...
import { legacyFieldMap } from "./legacyFieldMap";
...
const requiredFields: Record<string, readonly string[]> = {
  "EnterpriseBusinessApplication.tsx/formalEnterpriseData.ts:shell-scope": [
    "platformName",
  ...
  "data/marketDocumentFixtures.ts:marketDocuments": [
    "documentId",
    "workId",
    "documentLabel",
    "objectName",
    ...
    "fieldGroups.groupId",
    "fieldGroups.label",
    "fieldGroups.fields.fieldId",
    "fieldGroups.fields.label",
    "fieldGroups.fields.value",
    "fieldGroups.fields.unit",
    "fieldGroups.fields.note",
    "fieldGroups.fields.countsTowardCompletion",
    "fieldGroups.fields.requiresConfirmation",
    "validation.title",
    "validation.detail",
    "validation.pendingEvidence",
    "collectionChannels.mode",
    "collectionChannels.label",
    "collectionChannels.sourceDetail",
    "collectionChannels.validationResult",
    "collectionChannels.importRowLimit",
    "collectionChannels.importSummary.total",
    "collectionChannels.importSummary.accepted",
    "collectionChannels.importSummary.warnings",
    "collectionChannels.importSummary.errors",
    "collectionChannels.systemSummary.received",
    "collectionChannels.systemSummary.accepted",
    "collectionChannels.systemSummary.pending",
    "collectionChannels.systemSummary.failed",
    "collectionChannels.systemSummary.latestLabel",
    "collectionChannels.instruction",
    "collectionChannels.sourceRows.name",
    "collectionChannels.sourceRows.detail",
    "collectionChannels.sourceRows.state",
  ],
