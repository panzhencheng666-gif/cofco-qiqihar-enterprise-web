...
const allMarketScope: OperationalScope = {
  ...
  authorization: {
    ...
    permissionKeys: ["enterprise:fixtures:read", "market:object:manage"],
  },
};
...
describe("market monitoring workspace", () => {
  ...
  it("keeps implementation and governance wording out of market business workspaces", () => {
    for (const sourceFile of [
      "src/business/market/MarketObjectRegistry.tsx",
      "src/business/market/MarketTaskWorkspace.tsx",
      "src/business/market/MarketAnalysisWorkspace.tsx",
    ]) {
