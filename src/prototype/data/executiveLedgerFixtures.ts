...
export const prototypeExecutiveDefaultPeriodKey = "2026-W31" as const;
export const prototypeExecutiveSupportedPeriodKeys = [
...
export const executiveCoordinateOptions = {
  ...
  periods: [
    { id: prototypeExecutiveDefaultPeriodKey, label: "2026 年第 31 周" },
    { id: prototypeExecutiveSupportedPeriodKeys[1], label: "2025 年第 31 周" },
  ],
  dataLayers: [
